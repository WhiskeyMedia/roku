...
Function doRegistration() As Integer
   ...
   'Success case: getRegResult_success (always returns success)
    ...
    m.UrlBase         = "http://www.animevice.com/roku"
    m.UrlGetRegCode   = m.UrlBase + "/get-code"
    m.UrlGetRegResult = m.UrlBase + "/get-result"
    m.UrlWebSite      = "www.animevice.com/roku"
...
Function displayRegistrationScreen() As Object
    ...
    regscreen.SetTitle("")
    regscreen.AddParagraph("If you're a premium member, linking your account gives you access to subscriber-only videos and HD-quality streaming.")
